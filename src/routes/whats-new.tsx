...
export const Route = createFileRoute("/whats-new")({
  head: () => ({
    meta: [
      { title: "What's New — ShiftNotes" },
      {
        name: "description",
        content:
          "Latest ShiftNotes release notes — new features, improvements, and fixes for the doorman handoff board.",
      },
      { property: "og:title", content: "What's New — ShiftNotes" },
      {
        property: "og:description",
        content:
          "Latest ShiftNotes release notes — new features, improvements, and fixes.",
      },
    ],
  }),
